...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/epics-base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/epics-base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add epics-base epics-base-static-libs
# for installing globally
pixi global install epics-base epics-base-static-libs
```
...
It is possible to list all of the versions of `epics-base` available on your platform:
...
```
pixi search epics-base --channel conda-forge
```
